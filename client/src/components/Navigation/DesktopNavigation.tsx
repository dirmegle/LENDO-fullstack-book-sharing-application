...
export default function Navigation() {
  ...
  const handleClick = () => {
    ...
    const navClasses = classNames(styles.nav, 'hidden border border-border w-max-content p-4 bg-background 2xl:rounded-md rounded-r-md  md:flex flex-col items-center justify-center sticky top-4', isExpanded ? 'w-40' : 'w-16')
  return (
