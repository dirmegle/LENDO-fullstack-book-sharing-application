...
export default function Navigation() {
  ...
  const handleClick = () => {
    ...
    const navClasses = classNames(styles.nav, 'w-max-content p-4 bg-[#F3EBE5] rounded-md flex flex-col items-center justify-center sticky top-4', isExpanded ? 'w-44' : 'w-20')
  return (
